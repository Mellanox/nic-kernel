...
.. list-table:: Generic parameters implemented
   ...
   * - ``num_doorbells``
     - driverinit
     - This controls only the channel doorbells used by the netdev. In all
       ...
       - 1: One doorbell for all channels, the global one for everything else.
       - [2, max_num_channels]: Spread netdev channels equally across these
         doorbells.
