 ...
 * @v2_opt_in: Whether the caller has opted in to VFIO_DEVICE_FEATURE_MIG_PRECOPY_INFOv2
...
static inline int
vfio_check_precopy_ioctl(unsigned int cmd, unsigned long arg,
			 bool v2_opt_in, struct vfio_precopy_info *info)
{
	unsigned long minsz;
