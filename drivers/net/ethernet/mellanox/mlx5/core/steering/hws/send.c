				   ...
				   struct mlx5hws_send_ring_cq *cq)
{
	...
	MLX5_SET(wq, wq, log_wq_pg_sz, sq->wq_ctrl.buf.log_frag_sz - MLX5_ADAPTER_PAGE_SHIFT);
				   ...
				   struct mlx5hws_send_ring_cq *cq)
{
	...
	MLX5_SET(cqc, cqc, log_page_size, cq->wq_ctrl.buf.log_frag_sz - MLX5_ADAPTER_PAGE_SHIFT);
