...
static struct mlx5_irq_pool *sf_comp_irq_pool_get(struct mlx5_irq_table *irq_table)
{
	return irq_table->sf_comp_pool;
}

struct mlx5_irq_pool *mlx5_irq_table_get_comp_irq_pool(struct mlx5_core_dev *dev)
{
